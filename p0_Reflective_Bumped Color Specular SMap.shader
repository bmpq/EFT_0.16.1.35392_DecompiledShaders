	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp5.yzw = tmp5.xyz * _SpecColor.xyz;
                tmp2.w = tmp5.x * _Specularness;
                tmp6.xy = inp.texcoord.xy * _BumpTiling.xx;
                ...
                tmp3.w = dot(-tmp2.xyz, tmp7.xyz);
                tmp3.w = tmp3.w + tmp3.w;
                tmp2.xyz = tmp7.xyz * -tmp3.www + -tmp2.xyz;
                tmp8 = texCUBE(_Cube, tmp2.xyz);
                tmp2.xyz = tmp4.www * tmp8.xyz;
                ...
                if (tmp4.x) {
                    ...
                    tmp0.yzw = tmp4.xxx ? tmp7.xyz : tmp0.yzw;
                ...
                tmp0.yzw = tmp8.xyz + inp.texcoord6.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                if (tmp3.w) {
                    ...
                    tmp7.xyz = tmp7.xyz + unity_ProbeVolumeWorldToObject._m03_m13_m23;
                    tmp7.xyz = tmp3.www ? tmp7.xyz : inp.texcoord4.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp4 = tex2D(_SpecMap, inp.texcoord.xy);
                tmp4.yzw = tmp4.xyz * _SpecColor.xyz;
                ...
                tmp1.w = tmp1.w + tmp1.w;
                tmp1.xyz = tmp6.xyz * -tmp1.www + -tmp1.xyz;
                ...
                tmp0.yzw = tmp6.xyz + inp.texcoord8.xyz;
                tmp0.yzw = max(tmp0.yzw, float3(0.0, 0.0, 0.0));
                tmp0.yzw = log(tmp0.yzw);
                tmp0.yzw = tmp0.yzw * float3(0.4166667, 0.4166667, 0.4166667);
                tmp0.yzw = exp(tmp0.yzw);
                tmp0.yzw = tmp0.yzw * float3(1.055, 1.055, 1.055) + float3(-0.055, -0.055, -0.055);
                tmp0.yzw = max(tmp0.yzw, float3(0.0, 0.0, 0.0));
                o.sv_target1.xyz = tmp0.xxx * tmp4.yzw;
