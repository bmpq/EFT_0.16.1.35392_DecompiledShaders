Shader "Custom/Swamp Shader" {
	Properties {
		...
		[Space(30)] [Header(________________________________________________________________________________________________________________)] _Color1 ("Main Color 1", Vector) = (1,1,1,1)
		...
		[Space(30)] [Header(________________________________________________________________________________________________________________)] _Color2 ("Main Color 2", Vector) = (1,1,1,1)
		...
		[Space(30)] [Header(________________________________________________________________________________________________________________)] [Toggle(USE_MERGED_TEXTURES)] _UseMergedTextures ("Use Merged Tures", Float) = 0
