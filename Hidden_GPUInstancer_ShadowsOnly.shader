	...
	SubShader {
		...
		Pass {
			...
			v2f vert(appdata_full v)
			{
                ...
                tmp2.xyz = -tmp1.xyz * cb0[0].www + cb0[0].xyz;
                ...
                tmp0.w = sqrt(tmp0.w);
                tmp0.w = tmp0.w * cb1[5].z;
                tmp0.xyz = -tmp0.xyz * tmp0.www + tmp1.xyz;
                tmp0.w = cb1[5].z != 0.0;
                tmp0.xyz = tmp0.www ? tmp0.xyz : tmp1.xyz;
                tmp2 = tmp0.yyyy * cb3[18];
                tmp2 = cb3[17] * tmp0.xxxx + tmp2;
                tmp0 = cb3[19] * tmp0.zzzz + tmp2;
                tmp0 = cb3[20] * tmp1.wwww + tmp0;
                tmp1.x = cb1[5].x / tmp0.w;
                ...
                o.position.z = cb1[5].y * tmp0.x + tmp0.z;
                return o;
			}
			// Keywords: 
			fout frag(v2f inp)
