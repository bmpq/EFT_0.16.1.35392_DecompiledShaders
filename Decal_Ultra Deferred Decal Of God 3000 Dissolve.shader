Shader "Decal/Ultra Deferred Decal Of God 3000 Dissolve" {
	Properties {
		...
		_Dissolve ("Dissolve Power", Range(0, 1)) = 0
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                o.sv_target.xyz = tmp2.www ? tmp2.xyz : tmp0.xyz;
