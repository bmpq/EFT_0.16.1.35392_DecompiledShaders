Shader "Custom/Vert Paint Shader Gloss Solid" {
	Properties {
		...
		[Space(30)] [Header(_____________________________________________________________________________________________________________)] _Heights ("Heights", 2D) = "white" {}
